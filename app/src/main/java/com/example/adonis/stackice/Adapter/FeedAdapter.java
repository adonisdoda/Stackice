    ...
    public void onBindViewHolder(@NonNull final FeedViewHolder holder, int position) {
        ...
        try {
            if (rssObject.getItems().get(position).getLink().contains("marica.rj.gov")) {
                ...
                {
                    Picasso.get().load("http://maricainfo.com/wp-content/uploads/2017/06/logo-2017.png").placeholder(R.drawable.img_ic_flash_on_white_24dp).into(holder.imgNoticia);
